        ...
        {({ isActive }) => (
          <div
            className={classNames(
              "p-3 rounded-full inline-flex items-center gap-5 transition-colors group-hover:bg-[#2f3336]",
              {
                "font-bold": isActive,
              }
            )}
          >
            ...
            <p className="pr-4 text-xl">Anasayfa</p>
          </div>
        )}
      </NavLink>
      ...
      <NavLink to="/explore" className="py-1 block group">
        {({ isActive }) => (
          ...
          >
            ...
            <p className="pr-4 text-xl">Keşfet</p>
          </div>
        )}
      </NavLink>
    </nav>
